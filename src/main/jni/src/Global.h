...
struct {
   ...
   /*---------- TRANSFORM POSITION -----------*/
    ...
    uintptr_t get_isVisible = 0x7ba6474; // public override bool IsVisible()
	...
	uintptr_t get_IsGrenadeStart = 0x8b8f58; // public bool get_IsGrenadeStart() { }
	uintptr_t get_IsThrowingKnifeStart = 0x8b90b4; // public bool get_IsThrowingKnifeStart() { }
	uintptr_t get_IsWearingCamouflage = 0x8bb8ec; // public bool get_IsWearingCamouflage() { }
